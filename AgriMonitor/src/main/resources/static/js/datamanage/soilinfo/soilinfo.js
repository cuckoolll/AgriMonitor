	...
	function render() {
		...
		dataTable = table.render({
		     ...
		     cols: [[ //表头
		    	 ...
		    	 {field: 'code_number', title: '编号', width:180},
		    	 {field: 'organic', title: '有机质（g/kg）', width:200}, 
		    	 {field: 'nitrogen', title: '全氮（g/kg）', width:200},
		    	 {field: 'phosphorus', title: '全磷含量(g/kg)', width:180},
		    	 {field: 'effective_phosphorus', title: '有效磷含量(mg/kg)', width:180},
		    	 {field: 'potassium', title: '全钾含量(g/kg)', width:180},
		    	 {field: 'ph', title: 'pH', width:200},
		    	 {field: 'salinity', title: '盐度（%）', width:180},
