	...
	function renderTable() {
		dataTable = table.render({
		     ...
		     cols: [[ //表头
		       	 ...
		       	 {field: 'quality_address', title: '采样地点', width:100},
		       	 {field: 'quality_time', title: '采样时间', sort: true, width:100},
		       	 {field: 'water_temperature', title: '水温(℃)', width:100}, 
		       	 {field: 'ph', title: 'ph值', width:80},
		       	 {field: 'dissolved_oxygen', title: '溶解氧',width:100},
		       	 {field: 'permanganate_index', title: '高锰酸盐指数', width:150},
		       	 {field: 'chemical_oxygen_demand', title: '化学需氧量',width:120},
		       	 {field: 'five_day_bod', title: '五日生化需氧量', width:170},
		       	 ...
		       	 {field: 'copper', title: '铜',width:80},
		       	 {field: 'lead', title: '铅',width:80},
		       	 {field: 'cadmium', title: '镉',width:80},
		       	 {field: 'zinc', title: '锌',width:80},
		       	 {field: 'mercury', title: '汞',width:80},
		       	 {field: 'arsenic', title: '砷',width:80},
		       	 {field: 'selenium', title: '硒',width:80},
