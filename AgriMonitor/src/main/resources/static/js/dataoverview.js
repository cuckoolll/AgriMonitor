		...
		option1 = {
		    ...
		    tooltip : {
		        ...
		        formatter: function(param){
		        	if(param.data.data.areainfo.trim().length>0){
	        			return getNewline(param.data.data.areainfo);
	        		}else if(param.data.data&&param.data.data.village){
		        		var s=param.name+"<br/>"
		        		...
		        		return getNewline("哈尔盖镇是环青海湖地区最大的一个畜牧业镇，全镇土地总面积为1688平方公里，"
		        			  +"拥有可利用草场224.24万亩，耕地6.44万亩，经营各类牲畜278044头"
		        			  +"只、匹）。（全镇辖7个行政村、1个社区、24个生产合作社，共2630户10108"
		        			  +"人，其中藏族人口占总人口的91.6%，是一个以藏族为主的少数民族聚居地。境内"
		        			  +"交通便捷，青藏铁路、哈尔盖至木里地方铁路、国道315线、省道204线贯穿全境，"
		        			  +"经济、文化、信息交流联系便利，区位优势明显。境内有普氏原羚（中华对角羚）、"
		        			  +"岩羊、鹿、麝、冬虫夏草、黄芪、大黄、羌活、柴胡等野生动植物资源；有煤、铁、"
		        			  +"铜、银、铀等矿产资源。镇机关下属兽医站、学校、卫生院、社会发展中心、经济发展"
		        			  +"中心、水管所、公安派出所、森林公安派出所、司法所等9个镇属单位。全镇共有藏传"
		        			  +"佛教寺院3所，僧侣73人。全镇共有干部职工73名，其中女干部职工29人。镇党委"
		        			  +"下设9个党支部，党员总数共302名，女党员44名，占党员总数的15%；少数民族党员259名，占党员总数的86%。");
		        	}else if(param.data.name=='吉尔孟乡'){
		        		return getNewline("吉尔孟乡坐落于全国最美五大湖之首的“青海湖”西北岸，位于刚察县以西60公里处，"
		        		      +"地处海北州刚察县、海西州天峻县、海南州共和县三州三县交界处，地区总面积1463.6平方"
		        		      +"公里，境内有岩羊、鹿、麝、冬虫夏草、柴胡等野生动植物资源和煤、铁、铜等矿产资源。"
		        		      +"全乡辖5个行政村（牧业村：日芒村、环仓贡麻村、秀脑贡麻村、秀脑秀麻村；农业村：向阳村），"
		        		      +"15个生产合作社，有农牧户1072户3895人，其中：牧业1038户3809人，农业34户86人，"
		        		      +"是以藏族为主的少数民族聚居区，有藏、汉、回、蒙、土五个民族。全乡可利用草场188.43万亩，"
		        		      +"冬春草场100.48万亩，夏秋草场87.95万亩，存栏各类牲畜29.34万头，2018年全乡农牧民人"
		        		      +"均可支配收入13933元。全乡有党支部6个，共有党员188名（其中，1个机关党支部，5个村党支部），"
		        		      +"农牧民党员158名，机关党支部党员30名。全乡有干部职工36名（其中领导干部7名，经济发展服务中"
		        		      +"心干部7名，选调生行政编4人，党建信息员6名，寺院指导员3名，见习岗位4名，三支一扶2名，青南计划1名，"
		        		      +"公益性岗位2名）；乡属站所6个：乡兽医站、乡派出所、乡司法所、乡中心卫生院、乡幼儿园、乡水利工作站。"
		        		      +"乡辖藏传佛教寺院3座（日芒寺、秀脑寺、环仓寺），有活佛1名，僧侣96名。");
	        	    }else if(param.data.name=='泉吉乡'){
		        		return getNewline("泉吉乡辖6个行政村（其中1个农业村、5个牧业村），1个社区，1438户5696人，劳动力2936人，"
		        		      +"有藏、汉、蒙、回、土、满、东乡、撒拉8个民族，藏族占总人口的90％。乡属站所8个，其中学校3所"
		        		      +"（小学1所、幼儿园2所）、畜牧兽医工作站、卫生院、农村信用合作社、派出所、水管所各1所。可利用草场"
		        		      +"195.69万亩（其中冬春草场93.16万亩，夏秋草场102.53万亩），农作物耕地3148亩。经营各类牲畜"
		        		      +"18.86万只（头、匹），其中羊15.83万只、牛2.71万头、马3204匹，畜牧业为主导产业。农村常住居民"
		        		      +"人均可支配收入达16749.56元（其中牧区人均可支配收入达18025.55元，农区人均可支配收入达9652.25元）。");
	        	    }else if(param.data.name=='伊克乌兰乡'){
		        		return getNewline("伊克乌兰系蒙语，意为:“红色的河”，建政于1958年。位于县境中部偏西，东南与青海湖相连，西以泉吉"
		        		      +"河为界与泉吉乡毗邻，北以大通河为界与祁连县默勒镇相望。境内山脉走向北西，北部高山连绵，南部低缓，"
		        		      +"自北西向南倾斜，绝大部分地区海拔在3300－3800米以上。最高点4700米，位于瓦颜山峰，最低点"
		        		      +"3195米，位于青海湖滨湖地带的沙柳河（伊克乌兰河）入湖处，海拔相对高差1580米。境内高山、丘陵大致"
		        		      +"成北、中、南排列。北部为高山地段，中部丘陵，南部为地势较缓地带。气候属典型的高原大陆性气候，日照时间长，"
		        		      +"昼夜温差大；年降水量370.5毫米，年蒸发量1500.6—1847.8毫米。冬季寒冷，夏秋温凉，1月平均气温"
		        		      +"-17.5℃，7月平均气温11℃，年平均气温-0.6℃。系全县唯一的纯牧业乡，下辖6个行政村，16个社，1754"
		        		      +"户，6186人，以藏族为主，占总人口的98%。全乡土地总面积1778.7平方公里，占全县土地总面积的23.3％。"
		        		      +"草场总面积266.798万亩，可利用草场面积194.96万亩，占草场总面积的81.09%。畜均占有草场10.04"
		        		      +"亩，全乡牲畜存栏21.436万头只，母畜比例、仔畜繁活率、商品率分别达到61.54%、88.55%、44.58%。"
		        		      +"全乡出栏各类牲畜10.5万（头只匹），全年出售各类牲畜9.6万头（只）。村民收入主要依靠传统种养殖、外出务工、"
		        		      +"转移性收入为主，2018年农牧民人均收入达13286.67元，农牧业增加值6310.66万元，2017年全乡提前实现全面脱贫。");
	        	    }else if(param.data.name=='沙柳河镇'){
		        		return getNewline("沙柳河镇位于刚察县县境南部，县府驻地。人口13393人（2017），以汉族为主，还有藏、回等少数民族，"
	        		      +"面积1237.82平方千米。1957年设沙柳河乡，1958年同伊克乌兰区合并为伊克乌兰公社，1962年改为沙柳"
	        		      +"河乡，1969年改为沙柳河公社，1984年改为沙柳河乡。2001年3月5日青海省人民政府青政函[2001]15号"
	        		      +"文批复：撤销沙柳河乡，设立沙柳河镇。下辖新海、思乃、果洛仓贡麻、潘保、红山、尕曲、河东7个村（牧）委会。");
	        	    }else if(param.data.name=='刚察县'){
		        		return getNewline("刚察县为青海省海北藏族自治州辖县，省环湖重点牧业县之一，位于州境西部，青海湖北岸。" 
		        		+ "县政府驻沙柳河镇，距州府驻地海晏县西海镇110公里。截止2012年，全县总人口4.2万人 ，其中少数民族" 
		        		+ "占72.5%，藏族占63.38%，还有汉、蒙古、回、东乡等民族。面积1.2万平方公里。辖3乡2镇1场。古为羌地。" 
		        		+ "境内主要河流有默勒河、克克塞河、江仓河、沙柳河、巴哈乌兰河、布哈河、哈尔盖河、吉尔孟河。属高原大陆性气候，" 
		        		+ "年均温-0.6℃，年降水量370毫米。主要矿藏有煤、铁、铜、银、铀等。纯牧业县，牧养藏系绵羊，半细毛羊、牦牛、" 
		        		+ "马等。境内青海湖盛产湟鱼。青（海）藏（西藏）铁路横贯全境，青（海）新（疆）公路、湟"
		        		+"（源）嘉（峪关）公路通过境内，交通便利。 第一批国家农业可持续发展试验示范区。");
	        	    }else{
		        		return "无数据";
		        	}
				}
	        ...
	        if(res && res.areainfo.length>0){
	        	$.each(data,function(i,o){
	        		$.each(res.areainfo,function(index,item){
	        			if(item.xzmc==o.name){
	            			o.data.areainfo=item.xzms;
	            			return false;
	            		}
		        	});
        		});
	        	$.each(xzdata,function(i,o){
	        		$.each(res.areainfo,function(index,item){
	        			if(item.xzmc==o.name){
	            			o.data.areainfo=item.xzms;
	            			return false;
