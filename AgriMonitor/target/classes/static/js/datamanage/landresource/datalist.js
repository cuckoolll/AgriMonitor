	...
	function render(){
		...
		datatable=table.render({
		    ...
		    cols: [[ 
		      ...
		      {field: 'gdmj', title: '耕地面积（hm2）',align:'center',width:130},
		      {field: 'gbzltmj', title: '高标准农田面积（hm2）',align:'center',width:130},
		      {field: 'gbzltbz', title: '高标准农田比重（%）',align:'center',width:130},
