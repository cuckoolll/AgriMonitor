	...
	function render() {
		...
		dataTable = table.render({
		     ...
		     cols: [[ //表头
		    	 ...
		    	 {field: 'organic', title: '有机质（g/kg）', width:150}, 
		    	 {field: 'nitrogen', title: '全氮（g/kg）', width:150},
		    	 {field: 'phosphorus', title: '全磷含量(g/kg)', width:150},
		    	 {field: 'effective_phosphorus', title: '有效磷含量(mg/kg)', width:150},
		    	 {field: 'potassium', title: '全钾含量(g/kg)', width:150},
		    	 {field: 'ph', title: 'pH', width:120},
		    	 {field: 'salinity', title: '盐度（%）', width:150},
		    	 {field: 'available_potassium', title: '速效钾含量(mg/kg)', width:150},
		    	 {field: 'slow_release_potassium', title: '缓效钾含量(mg/kg)', width:150},
			 ]]
		  });
