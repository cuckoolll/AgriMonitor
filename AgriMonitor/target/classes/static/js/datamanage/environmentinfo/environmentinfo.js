		...
		dataTable = table.render({
		     ...
		     cols: [ 
		    	 ...
		    	 [ 
				     ...
				     {field: 'grass_vegetation_cover', title: '草原综合植被盖度',rowspan:2,width:145},
				     {title: '天然草原草畜平衡率',align:'center',colspan:2},
				     {title: '农田林网控制率',align:'center',colspan:2},
				     {title: '森林覆盖率',align:'center',colspan:2},
				     {field: 'wetland_area', title: '湿地面积', align:'center',rowspan:2, width:100}
			     ],
			     [
			    	 {field: 'grass_grazing_capacity', title: '天然草原合理载畜量', align:'center', width:160},
			    	 {field: 'grass_grazing_capacity_reality', title: '天然草原全年实际载畜量', align:'center', width:200},
			    	 {field: 'agroforestry_farm_area_built', title: '已建成农田林网的农田面积', align:'center', width:200},
			    	 {field: 'agroforestry_farm_area_predict', title: '应建农田林网的农田面积', align:'center', width:200},
			    	 {field: 'forestry_area', title: '森林面积', align:'center', width:100},
			    	 {field: 'land_area', title: '国土面积', align:'center', width:100}
			    ]]
		  });
